...
public class RelayListener
{
    ...
    private static readonly string[] LocalApiProxyPrefixes = ["Auth", "Equipment", "EquipmentCategory", "Translation", "EquipmentUpload", "EquipmentLink", "EquipmentLog", "ShiftScheduleVersion"];
